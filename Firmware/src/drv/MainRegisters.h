...
/// 
#define TIME_PERIOD_INTERRUPT           3686
...
//*****************************************************************************
/// \brief Имя функции обработки прерывания  АЦП 1.
/// 
#define ADC1_FUNCTION_INTERRUPT         __attribute__( ( __interrupt__, auto_psv,                  \
                                            save( MODCON, DSRPAG, DSWPAG ) ) ) _AD1Interrupt
...
{                                                                              \
    ...
    PR5 = TIME_PERIOD_INTERRUPT; /* Load 16-bit period value                */ \
...
{                                                                                                 \
    ...
    IPC3bits.AD1IP     = 1;          /* Установка приоритета прерываний по АЦП 1 */               \
    IEC0bits.AD1IE = 1;              /* Разрешение прерывания по завершению конвертации АЦП 1  */ \
