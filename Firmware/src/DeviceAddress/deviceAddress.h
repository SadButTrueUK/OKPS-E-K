...
//*****************************************************************************
/// \brief Направление перевода (для получения токов калибровки).
///

typedef enum {
    Plus, ///< Перевод в плюс
    Minus ///< Перевод в минус
} CalibrDir;
...
//*****************************************************************************
/// \brief Получить состояние наличия калибровок прибора
bool DeviceAddress_getIsCalibrPresents(CalibrDir dir);

//*****************************************************************************
/// \brief Получить значения тока калибровки 
uint16_t DeviceAddress_getCalibrCurrent(CalibrDir dir);

//*****************************************************************************
/// \brief Получить значение увеличенного времени перевода
