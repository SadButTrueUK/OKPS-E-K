...
//*****************************************************************************
///\brief Получить информацию о том. слышит сосед меня или нет.
/// \param str - указатель на структуру состояния.
/// \retval true  - сосед меня слышит.
/// \retval false - сосед меня не слышит.
bool ActivityManager_isNeighborHearsMe( ActivityManager_DeviceStr *str );


//*****************************************************************************
///\brief Получить информацию о состояния положения стрелки своего прибора
/// \param str - указатель на структуру состояния.
uint8_t ActivityManager_getOwnStatePosShift( ActivityManager_DeviceStr *str );

        
//*****************************************************************************
///\brief Установка состояния положения стрелки своего прибора
/// \param str - указатель на структуру состояния.
