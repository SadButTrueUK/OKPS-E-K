...
//*****************************************************************************
///\brief Установить состояние положения стрелки соседа 
/// \param str - указатель на структуру состояния.
/// \param state - состояние инициализации соседа (false - в процессе, true - окончено).
/// 
...
//*****************************************************************************
///\brief  Получить состояние положения стрелки соседа
/// \param str - указатель на структуру состояния.
/// \retval - значение положения стрелки соседнего прибора
uint8_t ActivityManager_getNeighborPositionShunt( ActivityManager_DeviceStr *str );


//*****************************************************************************
///\brief  Получить состояние связи соседа с УС по интерфейсу RS-422;
/// \param str - указатель на структуру состояния;
/// \retval true  - есть связь;
/// \retval false - нет связи.
