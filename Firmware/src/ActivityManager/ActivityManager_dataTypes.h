...
typedef struct 
{
    ...
    uint16_t neighborStatePosShift :2;        ///< Состояние положения стрелки соседа
    uint16_t ownStatePosShift      :2;        ///< Состояние положения стрелки соседа
    uint16_t unused                :3;        ///< Неиспользуемые.
