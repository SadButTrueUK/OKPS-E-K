...
// Расчет логарифма по основанию 2
	...
	/// \note Если макрос не определен ранее, будет использоваться таблица поиска.
    ///
...
/// \param me_ - объект очередь типа \a Set8_t.
///
...
//*****************************************************************************
/// \brief Макрос определяется как true если приоритетная очередь \a me_ не пуста.
/// \param me_ - объект очередь типа \a Set64_t.
///
...
/// \param dest_ - объект очередь типа \a Set64_t в который копируются элементы;
/// \param source_ – объект очередь типа \a Set64_t из которого копируются элементы.
///
